...
//         {projects.map((proj, i) => (
//           <div key={i} className="bg-white p-6 rounded-lg shadow border-l-4 border-blue-600">
//             <h3 className="text-2xl font-semibold">{proj.name}</h3>
//             <p className="text-gray-700 mt-2">{proj.description}</p>
//             <p className="text-sm text-gray-600 mt-3"><strong>Tech:</strong> {proj.tech}</p>
//             <div className="flex gap-4 mt-4">
//               <a href={proj.github} target="_blank" className="text-blue-600 hover:underline text-sm font-semibold">GitHub</a>
//               <a href={proj.live} target="_blank" className="text-blue-600 hover:underline text-sm font-semibold">Live Demo</a>
//             </div>
//           </div>
//         ))}
//       </div>
